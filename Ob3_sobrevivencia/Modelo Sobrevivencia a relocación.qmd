...
plot(sim_res)
#PostHOC
emmeans(model_glm_int, pairwise ~ time)
#interaccion 
emmeans(model_glm_int, pairwise ~ relocation | time)
...
#SOBREDISPERSION
check_overdispersion(model_glm_intb)
##DIAGNOSTICO GENERAL
sim_resb <- simulateResiduals(model_glm_intb)
plot(sim_resb)
#PostHOC
emmeans(model_glm_int, pairwise ~ time)
#interaccion 
